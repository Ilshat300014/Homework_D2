...
SECRET_KEY = 'django-insecure-0p)0d9@jv6)4obwrxznc&4dd+*gmstz1!sb+muz^m+1o#i$(1#'
...
ACCOUNT_LOGOUT_REDIRECT_URL = '/news/' # Ссылка после выхода из аккаунта
LOGIN_REDIRECT_URL = '/news/' # Ссылка куда направляются зарегестрированные пользователи
...
LOGGING = {
    ...
    'formatters': {
        ...
        'error_file_format': {
            'format': '{asctime} | {levelno} | {message} | {stack_info}',
            'style': '{'
        },
